...
public class FluxBatteryScreen extends AbstractContainerScreen<FluxBatteryMenu> {
    public FluxBatteryScreen(FluxBatteryMenu menu, Inventory inv, Component title) {
    ...
    protected void renderLabels(GuiGraphics graphics, int mouseX, int mouseY) {
        ...
        graphics.drawString(this.font, Component.translatable("gui.worlds_with_ores.flux.energy"), 28, 28, 0xFF93A3B0, false);
    }
    ...
    public void render(GuiGraphics graphics, int mouseX, int mouseY, float partialTick) {
        ...
        int x = this.leftPos;
        int y = this.topPos;
        if (mouseX >= x + 28 && mouseX < x + 168 && mouseY >= y + 40 && mouseY < y + 64) {
